...
1. 轨道相关功能：
    ...
    2. 新增了视角俯仰，现在视角俯仰将跟随列车俯仰变换。
    3. 修复了缆车节点在某些角度下无法连接的问题
    4. 提供了轨道形变选项，开启后轨道更平滑
    5. 调整了轨道区块构建逻辑，将构建过程从渲染线程分离，防止卡顿
    6. 新增了贝塞尔曲线模式
    7. 调整了轨道更新距离，现在的距离与视距绑定
    8. 重做了选取界面，支持分组/合并选择，自动保存位置
2. 装饰物件相关
...
4. 位移工具
    1. 修复了位移工具导致的崩溃问题
5. JavaScript 相关：
    1. 使用新的GraalJS引擎替换了原来的Rhino引擎，支持了更新的JS语法特性，可能引发一些兼容性问题或其他未知问题。
